<template>
  <v-container>
    <v-card>
      ...
      <v-card-text>
        <v-card class="pa-3 text-h2 primary lighten-4">
          컨텐츠
        </v-card>
